...
emojis.forEach(e => {
  ...
  span.addEventListener('click', () => insertAtCursor(input, e));
...
// Close only when clicking outside (not on emoji picker or button)
...
joinBtn.addEventListener('click', () => {
  ...
  form.addEventListener('submit', e => {
    ...
    input.value = '';
    input.focus(); 
    emojiPicker.style.display = 'none'; // Close emoji picker after sending
  });
