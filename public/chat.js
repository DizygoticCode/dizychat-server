...
const INFOWARS_MODAL_DEFAULT_WIDTH = 2000;
const INFOWARS_MODAL_DEFAULT_HEIGHT = Math.round(
  INFOWARS_MODAL_DEFAULT_WIDTH / INFOWARS_VIDEO_ASPECT_RATIO + INFOWARS_EMBED_CONTROL_PADDING
);
