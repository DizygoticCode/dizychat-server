...
2. Confirm scanner availability and status latency, or confirm `REQUIRE_UPLOAD_ANTIVIRUS_SCAN` is intentionally unset/false for deployments that do not require antivirus enforcement.
