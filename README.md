...
- **Dizygotic Rumble Chat Companion v1.9.2** extends Rumble itself with blocking/highlighting, keyword filtering, transcript capture/export, configurable chat appearance, DizyChat DM handoff, notifications, and independently switchable auto-burn engines from the companion userscript in `scripts/tampermonkey/`.
